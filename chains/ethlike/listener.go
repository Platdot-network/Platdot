...
import (
	...
	"github.com/Platdot-network/Platdot/bindings/ERC721Handler"
	"github.com/Platdot-network/Platdot/bindings/GenericHandler"
...
func (l *listener) reconnect() {
	...
	for {
		l.log.Info("Reconnect", "Time", ClientRetryLimit)
